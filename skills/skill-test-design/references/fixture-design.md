...
When testing skills that discover or read other skills (e.g., a skill-test-design skill that scans for `SKILL.md` files), the fixture must contain mock skills in the same directory structure the skill under test expects.
